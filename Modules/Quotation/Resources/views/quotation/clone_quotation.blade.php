                        ...
                        <div class="white_box_50px box_shadow_white">
                            ...
                            <div class="col-12 mt-3">
                                <div class="submit_btn text-center">
                                    <button class="primary-btn semi_large2 fix-gr-bg" onclick="fromSubmit()"><i class="ti-check"></i>{{__('quotation.Draft')}}</button>
                                    <button class="primary-btn semi_large2 fix-gr-bg" onclick="fromSubmitwithPreview()"><i class="ti-check"></i>{{__('quotation.Preview')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
