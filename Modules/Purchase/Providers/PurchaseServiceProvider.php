...
use Modules\Purchase\Repositories\SuggestListRepository;
use Modules\Purchase\Repositories\SuggestListRepositoryInterface;
...
class PurchaseServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(SuggestListRepositoryInterface::class, SuggestListRepository::class);
        $this->app->bind(CNFRepositoryInterface::class, CNFRepository::class);
    }
