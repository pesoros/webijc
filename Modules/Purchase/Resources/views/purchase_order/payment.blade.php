  ...
  <section class="admin-visitor-area up_st_admin_visitor">
    <div class="container-fluid p-0">
      <div class="row justify-content-center">
        ...
        <div class="col-12">
          <form action="{{route("purchase.store.payment",$order->id)}}" method="POST" class="payment_form"
            enctype="multipart/form-data">
            @csrf
            <div class="white_box_50px box_shadow_white">
              @if ($order->payments()->exists())
              <h3>{{__('sale.Paid Amount')}}: <span
                class="paid_amount"> {{ single_price($order->payments()->sum('amount')) }}</span></h3>
                @endif
                <input type="hidden"
                value="{{$order->payments->sum('amount') - $order->payments->sum('return_amount')}}"
                         ...
                         <div class="row">
                           <div class="col-md-6 col-lg-6 col-sm-12">
                             <div class="primary_input mb-15">
                               ...
                               onkeyup="getAmount('0')"
                               class="primary_input_field input_amounts cash_payment" value="{{ $order->payable_amount - ($order->payments->sum('amount') - $order->payments->sum('return_amount')) }}" placeholder="Enter Amount">
                             </div>
                           </div>
                           <div class="col-md-6 col-lg-6 col-sm-12">
                             <div class="primary_input mb-15">
                               ...
                               <li><a class="add_cash" data-id="5000" href="javascript:void(0)">5000 <span
                                 ...
                                 <li><a class="add_cash" data-id="1000" href="javascript:void(0)">1000 <span
                                   ...
                                   <li><a class="add_cash" data-id="500" href="javascript:void(0)">500 <span
                                     ...
                                     <input type="hidden" name="totall_bill" id="totall_bill" value="{{ $order->payable_amount }}">

                                     <div class="col-lg-12 text-center pt_15">
                                       <div class="total_quantity_buttons">
                                         <div class="primary_input">
                                           <label class="primary_input_label" for="">{{__('pos.Total Quantity')}}</label>
                                           <input class="primary_input_field" value="{{$order->total_quantity}}" type="text">
                                         </div>
                                         <div class="primary_input">
                                         ...
                                         <div class="payment_buttons">
                                           <button class="primary_color_btn dark_btn">{{single_price($order->payable_amount)}}</button>
