                    ...
                    <div class="row">
                            ...
                            <div class="primary_input mb-15">
                                ...
                                <div class="primary_datepicker_input">
                                    <div class="no-gutters input-right-icon">
                                        <div class="col">
                                            <div class="">
                                                <input placeholder="Date" class="primary_input_field primary-input date form-control" id="loan_date" type="text" name="loan_date" value="" autocomplete="off" required>
                                            </div>
                                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                ...
                                <input name="amount" id="amount" class="primary_input_field amount" placeholder="{{ __('common.Amount') }}" type="number" min="0" step="1" onkeyup="getMonthlyInstallment()" required>
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                ...
                                <input name="monthly_installment" id="monthly_installment" class="primary_input_field monthly_installment" placeholder="00.00" type="number" min="0" step="1" readonly>
                            </div>
                        </div>
