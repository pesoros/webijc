                    ...
                    <div class="col-12">
                        <div class="box_header">
                            <div class="main-title d-flex">
                                <h3 class="mb-0 mr-30">{{ __('common.Add New') }} {{ __('account.Journal') }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                                ...
                                <div class="row form">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input class="primary_input_field" name="sub_amount[]" id="sub_amount" placeholder="Amount" type="number">
