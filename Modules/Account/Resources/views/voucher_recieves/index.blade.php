                ...
                <div class="col-12">
                    <div class="box_header common_table_header">
                        <div class="main-title d-md-flex">
                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('account.Recieve') }}</h3>
                             @if(permissionCheck('voucher_recieve.store'))
                            <ul class="d-flex">
                                <li><a class="primary-btn radius_30px mr-10 fix-gr-bg" href="{{ route('voucher_recieve.create') }}"><i class="ti-plus"></i>{{ __('common.Add New') }} {{ __('account.Recieve') }}</a></li>
                            </ul>
                            @endif
                        </div>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($payment->referable_id)
                                                    ...
                                                    @endphp
                                                    <a onclick="getDetails({{ $payment->referable->id }})">{{ $payment->referable->invoice_no }}</a>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown CRM_dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
                                                        ...
                                                        @if(permissionCheck('voucher_recieve.edit'))
                                                            <a href="{{ route('voucher_recieve.edit', $payment->id) }}" data-toggle="modal" class="dropdown-item edit_brand">{{__('common.Edit')}}</a>
                                                        @endif
                                                        @if(permissionCheck('voucher_recieve.destroy'))
