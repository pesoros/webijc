                                ...
                                <div class="main-title d-flex flex-wrap">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center  flex-wrap flex-grow-1">
                                        ...
                                        <ul class="d-flex flex-wrap">
                                            <li><a download class="primary-btn radius_30px mr-10 fix-gr-bg" href="{{ asset('public/uploads/products.xlsx') }}"><i class="ti-import"></i>Sample File Download</a></li>
                                        </ul>
                                    </div>

                                </div>
                            </div>
                            <form action="{{route("add_product.csv_upload_store")}}" method="POST" enctype="multipart/form-data" class="csvForm">
                                @csrf
                                <div class="row form">
