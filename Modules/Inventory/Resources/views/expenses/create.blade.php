                ...
                <div class="col-12">
                    <div class="white_box_50px box_shadow_white">
                        ...
                        <form action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="primary_input mb-15">
                                        ...
                                        <div class="primary_datepicker_input">
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="">
                                                        <input placeholder="Date" value="{{date('m/d/Y')}}" class="primary_input_field primary-input date form-control" id="startDate" type="text" name="date" autocomplete="off" required>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="primary_input mb-15">
                                            ...
                                            <div class="primary_datepicker_input">
                                                <div class="no-gutters input-right-icon">
                                                    <div class="col">
                                                        <div class="">
                                                            <input placeholder="Date" class="primary_input_field primary-input date form-control" id="cheque_date" type="text" name="cheque_date" value="{{date('m/d/Y')}}" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <button class="" type="button">
                                                        <i class="ti-calendar" id="start-date-icon"></i>
                            ...
                            <hr>
                            <label class="primary_input_label text-center" for="" id="dynamic_text">Please Enter Your debit details</label>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="primary_input mb-15">
                                        ...
                                        <input class="primary_input_field" name="sub_amounts" id="sub_amounts" value="0" type="text" readonly>
