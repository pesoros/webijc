                    ...
                    <div class="col-12">
                        <div class="box_header">
                            <div class="main-title d-flex">
                                <h3 class="mb-0 mr-30">{{__('quotation.Clone to Quotation')}}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="white_box_50px box_shadow_white">
                                        ...
                                        <div class="col-lg-4 col-md-6">
                                            <div class="primary_input grid_input">
                                                ...
                                                <div class="input-group primary_input_coupon">
                                                    <input type="number" class="primary_input_field billing_inputs total_quantity"
                                            ...
                                            @endif >
                                                ...
                                                <div class="input-group primary_input_coupon">
                                                    <input type="text" class="primary_input_field billing_inputs product_discounts"
                                            ...
                                            <div class="primary_input grid_input">
                                                ...
                                                <div class="input-group primary_input_coupon">
                                                    <input type="text" class="primary_input_field billing_inputs total_price"
                                            ...
                                            @endif>
                                                ...
                                                <div class="input-group primary_input_coupon">
                                                    ...
                                                    class="primary_input_field total_discount_amount total_discount billing_inputs"readonly>
                                                    <div class="input-group-append">
                                                        <button> </button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="primary_input grid_input">
                                                ...
                                                <div class="input-group primary_input_coupon">
                                                    <input type="text" value="{{$quotation->payable_amount}}" class="primary_input_field billing_inputs total_amount" name="total_amount" readonly>
                                                    <div class="input-group-append">
                                                        <button> </button>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-12 mt-3">
                                <div class="submit_btn text-center">
                                    <button class="primary-btn semi_large2 fix-gr-bg" onclick="fromSubmit()"><iclass="ti-check"></i>{{__('quotation.Draft')}}</button>
                                    <button class="primary-btn semi_large2 fix-gr-bg" onclick="fromSubmitwithPreview()"><iclass="ti-check"></i>{{__('quotation.Preview')}}</button>
                                </div>
                            </div>
                        </div>
                    </div>
