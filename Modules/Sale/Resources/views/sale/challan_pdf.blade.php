        ...
        <div class="invoice_logo" style="width:75%">
            <table class="table-borderless">
                ...
                <tr>
                    ...
                    <td class="width_custom"><span class="p-1">:</span> {{$data->invoice_no}}</td>
                </tr>
                <tr>
                    <td>{{__('common.Challan Date')}}</td>
                    <td class="width_custom"><span class="p-1">:</span> {{date(app('general_setting')->dateFormat->format, strtotime($data->created_at))}}</td>
                </tr>
                <tr>
                    <td>{{__('common.Party Name')}}</td>
                    <td class="width_custom"><span class="p-1">:</span> {{@$name}}</td>
                </tr>
                <tr>
                    <td>{{__('common.Party Address')}}</td>
                    <td class="width_custom"><span class="p-1">:</span> {{@$address}}</td>
                </tr>
                <tr>
                    <td>{{__('common.Phone')}}</td>
                    <td class="width_custom"><span class="p-1">:</span> {{@$mobile}}</td>
                </tr>
                <tr>
