            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12 mb-3">
                    <div class="white_box_50px box_shadow_white pb-3">
                        <form class="" action="{{ route('supplier.bill.search') }}" method="GET">
                            <div class="row">
                                    ...
                                    <div class="primary_input mb-15">
                                        ...
                                        <div class="primary_datepicker_input">
                                            <div class="no-gutters input-right-icon">
                                                <div class="col">
                                                    <div class="">
                                                        <input placeholder="Date" class="primary_input_field primary-input date form-control" id="date" type="text" name="from_date" value="{{isset($from_date) ? $from_date : ''}}" autocomplete="off">
                                                    </div>
                                                </div>
                            ...
                            <div class="row justify-content-center">
                                    ...
                                    <div class="primary_input ml-2">
                                        <a href="{{route('supplier.bill')}}" class="primary-btn fix-gr-bg" id="save_button_parent"><i
