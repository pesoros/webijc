            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12 mb-3">
                    <div class="white_box_50px box_shadow_white pb-3">
                        <form class="" action="{{ route('sale.history.search') }}" method="GET">
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="primary_input mb-15">
                                        ...
                                        <select class="primary_select mb-15" name="customer_id" id="supplier_id">
                                            <option value="">{{__('attendance.Choose One')}}</option>
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="primary_input ml-2">
                                    <a href="{{route('sale.history')}}" class="primary-btn fix-gr-bg" id="save_button_parent"><i
                ...
                @isset($items)
                    <div class="col-12">
                        <div class="box_header common_table_header">
                            <div class="main-title d-md-flex">
                                <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('report.Sale Report') }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                                ...
                                <div class="">
                                    <table class="table Crm_table_active3">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">{{__('report.Customer')}} {{__('common.Name')}}</th>
                                        ...
                                        @foreach($items as $key=> $item)
                                            <tr>
                                                ...
                                                <td>{{@$item->itemable->customer->name}}</td>
                                                <td>
                                                    <a onclick="getDetails({{ $item->itemable->id }})">{{$item->itemable->ref_no}}</a>
                                                </td>
