            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12 mb-3">
                    <div class="white_box_50px box_shadow_white pb-3">
                        <form class="" action="{{ route('leadger_report.index') }}" method="GET">
                            <div class="row">
                                <div class="col">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="primary_input ml-2">
                                    <a href="{{route('leadger_report.index')}}" class="primary-btn fix-gr-bg" id="save_button_parent"><i class="fa fa-refresh"></i>{{ __('report.Reset') }}</a>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <div class="box_header common_table_header">
                            <div class="main-title d-md-flex">
                                ...
                                <ul class="d-flex">
                                    ...
                                    <li><a class="primary-btn radius_30px mr-10 fix-gr-bg" target="_blank"
                                           href="{{Illuminate\Support\Facades\Request::fullUrl()}}&mail=1"><i
                                                class="ti-printer"></i>{{__('report.Send Mail')}}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="QA_section QA_section_heading_custom check_box_table">
                            <div class="QA_table">
                                ...
                                @if ($accont_type == 1 || $accont_type == 3)
                                    @include('report::leadger_report.debit_transaction_list_table')
                                @else
                                    @include('report::leadger_report.credit_transaction_list_table')
                                @endif
                            </div>
                        </div>
                    </div>
