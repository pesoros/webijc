            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-12 mb-3">
                    <div class="white_box_50px box_shadow_white pb-3">
                        <form class="" action="{{ route('packing.product.search') }}" method="GET">
                            <div class="row">
                                <div class="col">
                ...
                @isset($items)
                    <div class="col-12">
                        <div class="box_header common_table_header">
                            <div class="main-title d-md-flex">
                                <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px">{{ __('report.Sent Products Packing Reports') }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                                ...
                                <div class="">
                                    <table class="table Crm_table_active3">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">{{__('report.Sent Qty')}}</th>
