            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('customer.minus_balance.store') }}" id="substractBalanceModalForm">
                    ...
                    <div class="row">
                        ...
                        <input class="primary_input_field" name="account_type" placeholder="{{__("account.Account Type")}}" type="hidden" value="credit" readonly>
                        ...
                        <div class="col-lg-6">
                            <div class="primary_input mb-15">
                                ...
                                <input class="primary_input_field" name="name_customer" placeholder="{{__('contact.Substaction Balance From')}}}" type="text" value="{{ \Modules\Account\Entities\ChartAccount::where('contactable_type', 'Modules\Contact\Entities\ContactModel')->where('contactable_id', $customer->id)->first()->name }}" readonly>
                                <input class="primary_input_field" name="sub_account_id[]" placeholder="{{__('contact.Substaction Balance From')}}}" type="hidden" value="{{ \Modules\Account\Entities\ChartAccount::where('contactable_type', 'Modules\Contact\Entities\ContactModel')->where('contactable_id', $customer->id)->first()->id }}" readonly>
