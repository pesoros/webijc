                    ...
                    <div class="row">
                        <div class="col-md-4 col-lg-4 col-sm-12">
                            ...
                            <table class="table table-borderless supplier_view">
                                ...
                                <tr><td>{{ __('contact.State') }}:</td><td>: <span class="ml-1"></span>{{ $customer->state }}</td></tr>
                                <tr><td>{{ __('contact.City') }}:</td><td>: <span class="ml-1"></span>{{ @$customer->city }}</td></tr>
                                ...
                                <tr><td>{{ __('common.Registered Date') }}</td><td>: <span class="ml-1"></span>{{ date(app('general_setting')->dateFormat->format, strtotime($customer->created_at)) }}</td></tr>
                                <tr>
