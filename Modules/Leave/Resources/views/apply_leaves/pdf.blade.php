...
<head>
    ...
    <title>{{generalSetting()->company_name}}</title>
...
<div class="invoice_heading">
    <div class="invoice_logo">
        <img src="{{asset(generalSetting()->logo ?? 'uploads/settings/logo.png')}}" width="100px" alt="">
    </div>
    ...
    <div class="invoice_logo">
        <table class="table-borderless">
            <tr>
                ...
                <td><b>:</b></td>
                <td>{{ generalSetting()->company_name }}</td>
            </tr>
            <tr>
                <td><b>{{__('common.Phone')}}</b></td>
                <td><b>:</b></td>
                <td><a href="tel:{{generalSetting()->phone}}">{{generalSetting()->phone}}</a></td>
            </tr>
            <tr>
                <td><b>{{__('common.Email')}}</b></td>
                <td><b>:</b></td>
                <td><a href="mailto:{{generalSetting()->email}}">{{generalSetting()->email}}</a>
                </td>
            </tr>
            <tr>
                <td><b>{{__('payroll.Address')}}</b></td>
                <td><b>:</b></td>
                <td><a href="">{{generalSetting()->address}}</a></td>
            </tr>
        </table>
    </div>
    <div class="invoice_logo">
