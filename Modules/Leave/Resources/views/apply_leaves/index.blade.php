                                ...
                                <table class="table Crm_table_active">
                                    ...
                                    @foreach($apply_leaves as $key => $apply_leave)
                                        <tr>
                                            ...
                                            <td>{{ date(app('general_setting')->dateFormat->format, strtotime($apply_leave->start_date)) }}</td>
                                            <td>{{ $apply_leave->end_date != '0000-00-00' ? formatDate($apply_leave->end_date) : '' }}</td>
                                            <td>{{ date(app('general_setting')->dateFormat->format, strtotime($apply_leave->apply_date)) }}</td>
                                            <td>
                                                ...
                                                <div class="dropdown CRM_dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        @if (permissionCheck('languages.edit_modal'))
                                                            ...
                                                            @endif
                                                        @endif
                                                        <a href="{{route('leave.application.download',$apply_leave->id)}}" class="dropdown-item">{{__('common.Download')}}</a>
                                                        @if ($apply_leave->status == 0)
