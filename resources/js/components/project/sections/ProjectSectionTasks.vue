...
<div >
    <div class="task_seperate_single_list d-flex bordered_header sortitem ">
        ...
        <div class="separated_sticky_cell">
            ...
            <button  class="subtask_toggle" type="button" data-toggle="collapse" :data-target="'#subtasklist_'+task.id" aria-expanded="false" aria-controls="collapseExample" v-if="task.tasks && task.tasks.length ">
            ...
            <div class="details_show_buton">
                <span class="open_project_details" @click="$emit('showTask', [task_index], section_index)"> {{trans('project::project.details')}} <i
...
<div class="collapse subtask_lists" :id="'subtasklist_'+task.id">
...
export default {
    ...
    components : {
        draggable, ProjectSectionTaskField, ProjectSectionTaskDetails, ProjectSectionSubTasks
    },
    props: {
        "task" : {
            type : Object
        ...
        submitTaskName() {
            if (this.input_changed) {
                ...
                axios.post('/task/update_name', {
                    ...
                    this.$emit('taskUpdated', this.section_index, this.task_index, data.data)
                });
