<template>
    <div class="tab-pane fade gray_content  active show " id="board" role="tabpanel" aria-labelledby="board-tab">
        ...
        <add-new-field-modal :add_new_field_modal="add_new_field_modal" :project="project"  @modalClosed="closeModal" @newFieldAdded="addNewField"/>
    </div>
</template>
