                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 employee_id_div">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="employee_id" id="employee_id" class="primary_input_field name" placeholder="{{ __('common.Staff Id') }}" value="{{ $staff->employee_id }}" type="text" required>
                                ...
                                <div class="primary_input mb-25">
                                    ...
                                    <select class="primary_select mb-25" name="warehouse_id" id="warehouse_id">
                                        @foreach (\Modules\Inventory\Entities\WareHouse::all() as $key => $warehouse)
                                            <option value="{{ $warehouse->id }}" @if ($warehouse->id == $staff->warehouse_id) selected @endif>{{ $warehouse->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="primary_input mb-25">
                                    ...
                                    <select class="primary_select mb-25" name="showroom_id" id="showroom_id" required>
                                        @foreach (\Modules\Inventory\Entities\ShowRoom::where('status', 1)->get() as $key => $showroom)
                                            <option value="{{ $showroom->id }}" @if ($showroom->id == $staff->showroom_id) selected @endif>{{ $showroom->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-xl-6">
                                <div class="primary_input mb-25">
                                    ...
                                    <select class="primary_select mb-25" name="role_id" id="role_id" required onchange="getRoleField()">
                                        @foreach ($roles as $key => $role)
                                            <option value="{{ $role->id }}-{{ $role->type }}" @if ($role->id == $staff->user->role_id) selected @endif>{{ $role->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-xl-6 basic_salary_div">
                                <div class="primary_input mb-25">
                                    ...
                                    <input name="basic_salary" id="basic_salary" class="primary_input_field name" placeholder="{{ __('common.Basic Salary') }}" type="number" value="{{ $staff->basic_salary }}" required>
